  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const tRes = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000'}/api/trips/${id}/details`);
        ...
        const revRes = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000'}/api/reviews/trip/${id}`);
        ...
        if (token) {
           ...
           const rRes = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000'}/api/reservations/user/active/${id}`, {
